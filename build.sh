...
~/dmd2-053/linux/bin32/dmd -version=D2 myversion.d src/net.d src/numbers.d src/mongo_h.d src/mongo.d src/bson_h.d src/bson.d src/md5.d -Hdexport -inline -d -release -lib -oflibmongod-D2
